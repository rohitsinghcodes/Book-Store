            ...
            <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='mb-4'>
                        ...
                        <input {...register("password", { required: true })} type="password" name='password' id='password' placeholder='Passowrd' className='shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow' />
                    </div>
                    {
                ...
                <p className='align-baseline font-medium mt-4 text-sm'>Haven't an account? Plese <Link to="/login" className='text-blue-500 hover:text-blue-700'>Login</Link></p>
